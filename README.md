...
Run `bash concat_hp2_supercontigs_and_introns_rename.sh <hp2_results_directory>`, where 'hp2_results_directory' is a directory containing HP2 output folders for each.
